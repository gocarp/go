...
// Package queue provides dynamic/static concurrent-safe queue.
//
// Features:
//
...
type Queue struct {
	...
	list   *list.List       // Underlying list structure for data maintaining.
	closed *types.Bool      // Whether queue is closed.
