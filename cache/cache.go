...
// Package cache provides kinds of cache management for process.
//
...
type localAdapter = Adapter // localAdapter is alias of Adapter, for embedded attribute purpose only.
...
func Get(ctx context.Context, key interface{}) (*vars.Var, error) {
...
func GetOrSet(ctx context.Context, key interface{}, value interface{}, duration time.Duration) (*vars.Var, error) {
...
// It deletes the `key` if `duration` < 0 or given `value` is nil, but it does nothing
// if `value` is a function and the function result is nil.
func GetOrSetFunc(ctx context.Context, key interface{}, f Func, duration time.Duration) (*vars.Var, error) {
...
// writing mutex lock for concurrent safety purpose.
func GetOrSetFuncLock(ctx context.Context, key interface{}, f Func, duration time.Duration) (*vars.Var, error) {
...
func Remove(ctx context.Context, keys ...interface{}) (value *vars.Var, err error) {
...
func Update(ctx context.Context, key interface{}, value interface{}) (oldValue *vars.Var, exist bool, err error) {
...
func MustGet(ctx context.Context, key interface{}) *vars.Var {
	return defaultCache.MustGet(ctx, key)
}

// MustGetOrSet acts like GetOrSet, but it panics if any error occurs.
func MustGetOrSet(ctx context.Context, key interface{}, value interface{}, duration time.Duration) *vars.Var {
...
func MustGetOrSetFunc(ctx context.Context, key interface{}, f Func, duration time.Duration) *vars.Var {
...
func MustGetOrSetFuncLock(ctx context.Context, key interface{}, f Func, duration time.Duration) *vars.Var {
