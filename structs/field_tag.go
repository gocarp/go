...
// TagPriorityName checks and returns tag name that matches the name item in `tag.StructTagPriority`.
// It or else returns attribute field Name if it doesn't have a tag name by `tag.StructsTagPriority`.
